...
const LINKS = [
  { href: "/printer", label: "Job queue", icon: IconPrinter },
  { href: "/printer/completed", label: "Completed", icon: IconCircleCheck },
];
    ...
    <aside className="hidden w-60 flex-none flex-col border-r border-border bg-white lg:flex">
      <div className="flex h-nav items-center border-b border-border px-6">
        <Link href="/" className="flex items-center gap-2.5">
          <span className="flex h-8 w-8 items-center justify-center rounded-md bg-tint-blueText text-white">
            <IconPrinter size={16} strokeWidth={1.8} />
          </span>
